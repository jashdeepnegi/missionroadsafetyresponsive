...
<html>
	...
	<meta name="viewport" content="width=1024">
        ...
        <!-- Global site tag (gtag.js) - Google Analytics -->
            <script async src="https://www.googletagmanager.com/gtag/js?id=UA-144735720-6"></script>
            <script>
              window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
            
              gtag('config', 'UA-144735720-6');
            </script>
  ...
  <script type="text/javascript">
	...
	$(document).ready(function(){
	    if (isMobile.any())  {
		    console.log('iiii')
  			$("body").html('<img class="myimageMobile" src="/IMG_20190703_183649.jpg" alt="Smiley face" >') 
  			return;
		} else {
		    console.log('biii')
    ...
    <div class="row">
      <div class="col-lg-5" style="background-color:white;">
        <h5 style="text-align:center;color:#43425D;">Hover over any state to get details of the road crashes.</h5>
          ...
          <div id="map2017" class="map w3-animate-opacity" style="height:431px;"></div>
