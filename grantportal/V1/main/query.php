...
$password = "irsc2018";
$dbname = "ngoportal";
$ok = 0 ; // normal query box
$queryid = $_GET['refid'] ;
if ($queryid != "")
{
$queryid = strtolower($queryid) ;
...
$sql = "SELECT * FROM annexA OR annexB
 where uniqueid='$queryid'";
...
<html>
  <head>
    <title>Mission Road Safety - NGO's Portal Query Resolution</title>
